    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            try {
                ...
                core.info("token length: " + ((_a = process.env.GITHUB_TOKEN) === null || _a === void 0 ? void 0 : _a.length));
                rest = new octokit.Octokit({ auth: "token " + process.env.GITHUB_TOKEN });
